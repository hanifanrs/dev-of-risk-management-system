...
colnames(sortedlog_mer)[colnames(sortedlog_mer) == 'rendite_mer[order(logreturn2)'] <- 'rendite_merneu'
colnames(sortedlog_dbk)[colnames(sortedlog_mer) == 'rendite_db[order(logreturn2)'] <- 'rendite_dbneu'
